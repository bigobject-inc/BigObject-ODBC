...
#ifndef _BIGOBJECT_ODBC_CLIENT_SERVICE_IMPL_CSV_
#define _BIGOBJECT_ODBC_CLIENT_SERVICE_IMPL_CSV_
...
/**
Service implementation for reading CSV as database. NO SQL SUPPORT.
*/
class CSVServiceImpl : public ServiceInterface<CSVServiceImpl>
{
public:
